...
Gli Agent e Manager delle celebrità non sono del tutto sconosciuti, ma la loro fama è molto inferiore, paragonabile a quella di un parente stretto di una persona famosa, con un'enorme differenza in termini di popolarità.
...
- Nonostante la sua notorietà è rimasta fedele al suo gruppo di amici originale chiamato Pantere.
