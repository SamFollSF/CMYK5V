...
Gli Angeli Argentati sono noti per la loro incredibile agilità e abilità nei combattimenti aerei grazie alle loro ali metalliche. Il mito che li rappresenta è una figura femminile snella, la cui armatura riduce al minimo le forme tradizionalmente femminili, senza però intaccarne la femminilità. L'essenzialità è un elemento chiave del loro design, motivo per cui indossano sempre un copri occhio su uno dei loro occhi, inizialmente usato per proteggerlo e utilizzarlo solo nei momenti cruciali. Oggi, questo dettaglio è diventato più un simbolo.
...
Il Bruto Dorato ha il delicato compito di monitorare e controllare gli Agent e i Manager che accedono al [Deep Web Esposto](../Remix/metal.md) per consultare i propri archivi di password e altri dati sensibili. Questa regione del Web è infatti altamente militarizzata e sottoposta a un rigido controllo.
...
Non esiste un solo mito isolato ma molteplici. La figura presente nella carta è EmmeElle, figura di speranza e di rispetto. Quello che dovete sapere è che nel caso del Platino i miti servono più per dare una facciata positiva al metallo, che viene storicamente visto da una considerevole fetta di utenza come una seria minaccia per l'incolumità della popolazione del Web. Oggi le cose sono migliorate ma l'opinione pubblicca è ugualemnte divisa in due: chi appoggia l'idea di avere un metallo così potente e chi ne vorrebbe l'estinzione.
