...
Quello più comune, anche se comune si fa per dire. A differenza dei cristalli minori, il diamante conferisca una vera e propria svolta per i combattimenti. Oltre ad avere tutti i poteri dei 9 cristalli già citati, se ne aggiunge un decimo, unico per ogni diamante.

Per quanto riguarda il diamante azzurro, il suo potere speciale è quello di entrare in simbiosi con l'ambiente circostante, modificandolo e cristallizzandolo a proprio piacimento.

[Solisnoctix](../Magenta/solisnoctix.md) è in possesso di un Diamante azzurro, quello che può fare è ad esempio entrare in un auto, fondendosi con essa, cambiare la sua composizione chimica in 100% cristallo, e poterla scaraventare contro un bersaglio, tutto in meno di 5 secondi. Per certi versi può ricordare il tocco di Mida, solo che qui si rendono gli oggetti cristalli durissimi, non Diamanti extra, ma comunque impossibili per qualsiasi cristallo o metallo che non sia [Platino](../Remix/metal.md) da scalfire.

### Diamante Rosa

![Diamante Rosa](../eg/5/Pink%20Diamond.jpg)

Il gradino intermedio. Entriamo nella zona dove il potere diventa biomeccanicamente impossibile da sostenere per un Agent, al pari di quello che accade possedendo più di 70% di [Platino](../Remix/metal.md) per massa corporea. Nonostante la pericolosità di questa gemma, molte ricerche effettuate suggeriscono un potere che possa arrivare al pari circa di un [Platino](../Remix/metal.md) all'80% per massa corporea. Ma c'è di più, è sempre più accertato che Web Crystals così forti come i Diamanti sono un ottimo rimedio contro i parassiti metallici.
...
![Diamante Rosso](../eg/5/red%20diamond.jpg)

Con il Diamante Rosso si entra nella sfera speculativa, dal momento che non è certa nemmeno la sua stessa esistenza. Infatti ciò che è attualmente conosciuto è che il potere dei Diamanti e [Metalli Nobili](../Remix/metal.md) cresce in modo esponenziale, e quindi se per il [Platino](../Remix/metal.md) al 70% esiste una controparte cristallina, ovvero il Diamante Azzurro, e così via per il [Platino](../Remix/metal.md) all'80% con il Diamante Rosa, deve esserci qualcosa che possa controbilanciare il [Platino](../Remix/metal.md) dal 90% al 100%.

Leggende narrano di questo Diamante Rosso in grado di rendere chi ne fosse in possesso una vera e propria divinità, capace di sovvertire tutte le regole e il destino del WebVerse, in grado di poter letteralmente riscrivere la storia dell'intero universo. A raccontarlo furono i fondatori del Web, che parlarono di questa bellissima gemma rossa che uccise un loro compagno nel momento in cui egli prese in mano la pietra preziosa, dato il sovraccarico di radiazioni. Parliamo di poco più di 1 carato, ma sarebbe sufficiente secondo alcune stime per sprigionare tutto il potere di questo cristallo.

Ad esclusione, l'unica zona del WebVerse dove potrebbe esserci questo minerale è il Dark Web, dove è stato provata una grande quantità di Web Crystals, ma nessuno ha mai potuto provare l'esistenza di un Diamante Rosso.

Inutile dire che tutta questa storia interessa agli Overlords del Web, e la corsa al Diamante Rosso può essere davvero pericolosa, portando alla follia più totale, cercando qualcosa che non si è nemmeno sicuri esista. Tra i principali ricercatori di questa infinita gloria troviamo [Sa742Sa](../Remix/sa742sa.md) e [Solisnoctix](../Magenta/solisnoctix.md).
