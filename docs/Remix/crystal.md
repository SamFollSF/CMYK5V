...
Il Cursore di Zaffiro funziona come la freccia del mouse e si può usare in due modi:
- Click Sinistro: Afferra un nemico o un oggetto per spostarlo nello spazio. Finchè si tratta di materiali comuni o di [Rame](../Remix/metal.md) il suo funzionamento è impeccabile. Ma se ci spostiamo ai piani più alti come l'[Oro](../Remix/metal.md) la storia cambia radiclamente: spostare mineriali più nobili è praticamente inutile in combattimento data la loro densità di dati.
- Click Destro: Come per il click sinistro più il minerale è denso di dati e più lo Zaffiro arrancherà nell'elaborazione delle funzioni. Come per la controparte reale questo click permette di aprire un menù a tendina di fianco all'oggetto / nemico selezionato. Il menù prevede funzioni come "Ispeziona", "Copia" (se si dispone di una [Forbice Copypasta](../Remix/tool.md)), "Muta" per silenziare i suoni e ultimo ma assolutamente non per importanza il tasto "Pausa". Quest'ultimo bloccherà completamente il nemico, rendendolo un perfetto ornamento in soggiorno. Il funzionamento è impeccabile se si combatte nemici dello stesso livello, ma se si vuole mettere in pausa un Rubino bisogna aspettare (con tanto di rotella di caricamento) che lo Zaffiro analizzi tutta l'unità prima di intervenire. È teoricamente possibile congelare un Rubino? Sì. Quanto dura l'analisi? 5 minuti. Il nemico ha tutto il tempo prendersi un caffè al bar per poi disintegrarti. Per un Diamante Azzurro? 18 ore.

## Rubino

![rubino](../eg/5/rubino.jpg)

Il Rubino è il Web Crystal che precede l'élite della gerarchia. In questi termini non delude affatto, presentandosi come controparte cristallina dell'[Oro](../Remix/metal.md).

La sua peculiarità risiede nell'utilizzo della tecnologia Thunderbolt. Il Rubino permette di "connettersi" al nemico letteralmente con un cavo sparato a velocità elevatissime verso il bersaglio, e una volta connesso non c'è speranza per l'eventuale [Bruto Dorato](../Remix/metal.md). Il cavo permette al Rubino di controllare il corpo dell'obiettivo, facendo perdere qualsiasi tipo di controllo, ricordando quello che si prova in una paralisi. Non è tutto, la tecnologia Thunderbolt ha una caratteristica unica: permette di creare dei ponti fra hardware diversi sfruttando l'immensità della largezza di banda. Tradotto: nel caso in cui un Agent in possesso di Rubino si trovi di fronte a venti [Cavalieri di Rame](../Remix/metal.md) può usare il suo potere per avviare una catena di connessioni, che parte dal primo cavaliere e si espande al secondo, poi al terzo e così via sfruttando un solo filamento di Rubino.

Il cavo può estendrsi per la sorprendente distanza di massimo un milione di pixel (1Km), ma è qui che il cristallo mostra il fianco: più il cavo si allunga e non solo perde largezza di banda disponibile man mano che si controllano più nemici insieme, ma si assottiglia fisicamente, e più è sottile e più è facile da tagliare. Se si rimane nei dieci metri allora solo l'[Oro](../Remix/metal.md) può tagliarlo, ma quando si estende per tantissimi pixel allora anche il [Rame](../Remix/metal.md) può tagliarlo, mandando in crash il Rubino costringendo il possessore ad aspettare un caricamento di riavvio, che può durare anche diversi minuti.
...
Tutta questa storia è di forte interesse per gli Overlords del Web, e la corsa al Diamante Oscuro può essere davvero pericolosa, portando alla follia più totale, cercando qualcosa che non si è nemmeno sicuri esista. Tra i principali ricercatori di questa infinita gloria troviamo [Sa742Sa](../Remix/sa742sa.md) e [Solisnoctix](../Magenta/solisnoctix.md).
