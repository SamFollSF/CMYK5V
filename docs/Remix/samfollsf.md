...
- SamFollSF è un caso ancora aperto della [Web Intelligence](../Remix/deep.md), sotto la supervisione di [Angy](../Giallo/angy.md). (Volume III: FREAK-LEADER)

- Evase dalla prigione più grande del Network 742, il [DeadLocked](../Remix/sa742sa.md). Tuttavia, a causa della sua fuga, se venisse catturato nuovamente, dovrebbe scontare una pena di dieci anni. Attualmente, sulle sue tracce si trova [Sawako](../Magenta/sawako.md), motivata a porre fine a questa storia. (Volume VIII: BIG LIE)

- Nell'autunno del 2023, Sam e [OpsGiuly](../Nero/opsgiuly.md) verranno catturati dall'operazione [Red Winter](../Magenta/alesdreams.md) per il possesso illecito di [Strumenti dei Fondatori](../Remix/tool.md). La loro forzata alleanza per risolvere questa faccenda avrà effetti devastanti per entrambi. (Volume IV: RED WINTER)

- SamFollSf è in tensione con la [Snoctix.Inc](../Magenta/solisnoctix.md), dopo aver cercato di violare la console per il tracciamento di dati sensibili di [Brioche33](../Magenta/brioche33.md) e [PickMeGiuls](../Ciano/pickmegiuls.md). [Solisnoctix](../Magenta/solisnoctix.md) come il suo solito avrebbe semplicemnte fatto fuori la minaccia di turno, ma SamFollSF aveva un asso nella manica, rendendo la storia tra vincitore e un vinto più arzigogolata del dovuto. (Volume VI: BE OKAY)
...
Da quel giorno, il parassita si è insediato nel corpo di Sam, incarnando e spingendo al limite la sua parte più malvagia e spietata. Ribellarsi è complicato, un combattimento con un essere così insidioso è quasi sempre controproducente per entrambi, arrivando perfino alla morte dell'Agent se il parassita si stufa di lui.

![samfollsf3](../eg/5/samfoll3.jpg)

Ora il nostro SamFollSF non è solo nei guai con gli altri, ma anche con se stesso. Riuscirà a sconfiggere il suo male interiore e a riappacificarsi con i suoi nemici? Oppure, perché no, deciderà di eliminare anche loro?
