...
Facciamo un tuffo negli anni ’70, anche se di quel decennio qui c’è ben poco senò nel vestiario chic. Androzz è un Agent molto abile nella modellazione 3D, utilizzando software come Blender, un mondo lontano dalle competenze di [SamFollSF](../Remix/samfollsf.md). Questa capacità lo rende ben attrezzato grazie al suo armamentario personalizzato. Di come il PLA viene introdotto nel WebVerse, ne viene discusso ampliamente nella carta di [Marwis](../Ciano/marwis.md)
...
- Sulla sua canotta è presente la scritta "Vomero" con annesso il Network 272.
